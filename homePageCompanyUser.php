                                    ...
                                    <div class="container-fluid">
                                        <div class="collapse navbar-collapse">
                                            ...
                                            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                                                <li class="nav-item">
                                                    <button class="btn m-1 btn-style btn-action" id="nav-btn-13">
                                                        Angajati

                                                    </button>
                                                </li>
                                                <li class="nav-item">
                                                    <button class="btn m-1 btn-style btn-action" id="nav-btn-14">Stocuri
                                                        produse
                                                    </button>
                                                </li>
                                                <li class="nav-item">
                                                    <button class="btn m-1 btn-style btn-action" id="nav-btn-15">
                                                        Cumparare marfa
                                                    </button>
                                                </li>
                                                <li class="nav-item">
                                                    <button class="btn m-1 btn-style btn-action" id="nav-btn-16">
                                                        Vanzare marfa
                                                    </button>
                                                </li>
                                                <li class="nav-item">
                                                    <button class="btn m-1 btn-style btn-action" id="nav-btn-17">
                                                        Afisare tranzactii
                                                    </button>
                                                </li>
                                                <li class="nav-item">
                                                    <button class="btn m-1 btn-style btn-action" id="nav-btn-18">
                                                        Plati si incasari
                                                    </button>
                                                </li>
                                                <li class="nav-item">
                                                    <button class="btn m-1 btn-style btn-action" id="nav-btn-19">Raport
                                                        contabil lunar
                                                    </button>
                                                </li>
                                            </ul>
