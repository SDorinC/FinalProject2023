        ...
        <div class="table-responsive table-scroll h-100" style="position: relative">
            <table class="table table-striped mb-0" id="dataTable">
                ...
                <tr class="text-uppercase">
                    ...
                    <th scope="col" class="py-0">CUI/CIF</th>
                    <th scope="col" class="py-0">Data adaugarii</th>
                </tr>
                </thead>
...
<script>
    $(document).ready(function () {
        let urlValue = 'parts/siteAdmin/siteAdminShowCompaniesList/siteAdminShowCompaniesList_Controller.php';
